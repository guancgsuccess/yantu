 ...
 * 短信验证码
 */
public class SendTelMsgUtil {
    /**
     * ACCOUNT_SID:开发者主账号ID(注册后自动生成)
     */
    public static final String ACCOUNT_SID = "6cc837a6fbe741bcaabf54f11d0e623b";

    /**
     * AUTH_TOKEN:开发者账号认证密匙(注册后自动生成)
     */
    public static final String AUTH_TOKEN = "9526396aa62a4899b027d1bb6bee93c2";
...
//    public static final String BASE_URL = "https://api.miaodiyun.com";
     ...
     */
    public static String smsContent = "【沿途旅行】您的验证码为"+randNum+"，如非本人操作，请忽略此短信。";
    ...
    public static void main(String[] args) {
        ...
        String result = sendMsgTo("17678627809");
